...
KREWES = {'orpheus':['Emily', 'Kevin', 'Vishwaa', 'Eric', 'ray', 'Jesse', 'Tiffany', 'Amanda', 'Junhee', 'Jackie', 'Tyler', 'Emory',
          ...
          'Hilary', 'Ayham', 'Michael', 'Matthew', 'Jionghao', 'Devin', 'David', 'Jacob', 'Will', 'Hannah', 'Alex'],
...
def function(dict):
    ...
    ## stores the keys of the dictionary as teams
    team = rand.choice(teams)
    ## credit: the function rand.choice was suggested by Kiran when I was discussing randint with her
    ## choose a random team from the list of teams
    print(rand.choice(dict[team]))
    ## choose a random name from the randomly chosen team and print it
